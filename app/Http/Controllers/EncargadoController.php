...
class EncargadoController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request){
			...
			->orderBy('id','desc')
            ->paginate(7);
            return view('encargado.index',["personas"=>$personas,"searchText"=>$query]);
        }
    }
    ...
    {
        return view('encargado.show',["persona"=>User::findOrFail($id)]);
    }
    ...
    {
        return view("encargado.edit",["persona"=>User::findOrFail($id)]); 
    }
